  ...
  .action(async (opts) => {
    ...
    try {
      ...
      for (const collection of collectionsForScripts) {
        const scriptSource = generateMigrationScriptForCollection(collection);
...
function generateMigrationScriptForCollection(collection: NoSqlCollection): string {
  ...
  return `// Auto-generated by sql2nosql. Edit as needed.\n` +
    `// This script transforms a SQL row into a NoSQL document for the "${collection.name}" collection.\n\n` +
